...
write.csv(fit2,file="/mnt/storage/user/guixiuqi/rsgeno/protein/reversezMAP_github/data/test_data/gsva/kegg_gsva_differential_pathway_activity.csv")
write.csv(top,file="/mnt/storage/user/guixiuqi/rsgeno/protein/reversezMAP_github/data/test_data/gsva/kegg_gsva_differential_pathway_activity_top_50.csv")
