...
def association_with_clinical_feature_(z_statistic_matrix,cluster,clinical_info,discrete,continuous,color_f,colorbar_f,outdir,fdr,cluster_n):
    ...
    print("%s common samples in input files were included in subsequant analysis."%(len(overlap_sample)))
    ...
    print("Identifying differentially expressed proteins between sample groups.")
    ...
    print("performing clustering on differentially expressed proteins(DEPs) to recognize expression signatures. DEPs will be clustered into %s clusters"%(str(cluster_n)))
    print("performing pathway enrichment analysis on proteins coressponding each cluster.")
    ...
    print("Generating the result picture.")
    import argparse
...
if __name__=="__main__":
    ...
    association_with_clinical_feature_(z_statistic_matrix,cluster,clinical_info,discrete,continuous,color_f,colorbar_f,outdir,fdr,cluster_n)
