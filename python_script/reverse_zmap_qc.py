...
def data_qc(final_intensity_df,fig_dir=""):
    ...
    replace_intensity_df = final_intensity_df
    ...
    plt.savefig(fig_dir+"/"+"qc_boxplot.pdf",dpi=300,bbox_inches="tight")
    ...
    plt.savefig(fig_dir+"/"+"qc_table.pdf",dpi=300,bbox_inches="tight")  
